...
<body>
	...
	<div class="row" style="margin-top:30px;">
  		...
  		<button type="button" class="btn btn-primary dropdown-toggle" id="start1">开启1</button>
  		<button type="button" class="btn btn-success dropdown-toggle" id="stop1">关闭1</button>
	</div>
	...
	<div class="row" style="margin-top:10px;">
  		...
  		<button type="button" class="btn btn-primary dropdown-toggle" id="start2">开启2</button>
  		<button type="button" class="btn btn-success dropdown-toggle" id="stop2">关闭2</button>
	</div>
</body>
